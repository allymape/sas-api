...
anzishaShuleRequestRouter.post("/view-ombi-details", (req, res) => {
      var trackingNumber = req.body.TrackingNumber;
      
      model.anzishaShuleRequestView(trackingNumber ,(error , obj,objMess, objAttachment, objAttachment1,objAttachment2,objStaffs,objApps, objMaoni) => {
...
// coment this one or remove
anzishaShuleRequestRouter.get("/view-ombi-details", (req, res, next) => {
