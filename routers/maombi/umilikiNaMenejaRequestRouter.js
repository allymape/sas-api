...
umilikiNaMenejaRequestRouter.post(
  ...
  (req, res) => {
    ...
    db.query(
      `SELECT manager_first_name, manager_middle_name, authorized_person, application_category_id, establishing_schools.registry_type_id AS registry_type_id, title, manager_last_name, 
      ...
      function (error, results) {
        ...
        sharedModel.myMaoni(trackingNumber, (objMaoni) => {
          sharedModel.myStaffs(user, (objStaffs) => {
           ...
           WHERE regions.RegionCode = districts.RegionCode AND districts.LgaCode = wards.LgaCode AND referees.ward_id = wards.WardCode 
