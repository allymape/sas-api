  ...
  (req, res) => {
    ...
    db.query(
      "select school_categories.category as schoolCategory, applications.tracking_number as tracking_number, " +
        ...
        " AND application_category_id = 9 AND is_approved <> 2  AND payment_status_id = 2 " +
    ...
    var objAttachment2 = [];
      ...
      db.query(
        "SELECT registration_structures.structure as structure, establishing_schools.id as establishId, " +
          ...
          " AND application_category_id = 9 AND applications.tracking_number = ?",
        [trackingNumber],
        function (error, results) {
          if (error) {
            console.log(error);
          ...
          sharedModel.getAttachmentTypes(registry_type_id,application_category_id,"",(attachments) => {
