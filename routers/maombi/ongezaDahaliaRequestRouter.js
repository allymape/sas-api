...
ongezaDahaliaRequestRouter.post(
    ...
    // if(UserLevel == 33){
        ...
        ' AND application_category_id = 17 AND is_approved <> 2', 
        function (error, results, fields) {
            ...
            for(var i = 0; i < results.length; i++){
                ...
                obj.push({"tracking_number": tracking_number, "school_name": school_name, 
                        "LgaName": LgaName, "RegionName": RegionName, "user_id": user_id, 
                        "registry_type_id": registry_type_id, "registry": registry, 
                        "created_at": created_at, "remain_days": remain_days, "schoolCategory": schoolCategory})           
            }
            // console.log(obj)
            return res.send({ 
                error: false, 
