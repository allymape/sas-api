...
const ripotiWamilikiRequestRouter = express.Router();
const { isAuth, formatDate } = require("../../utils");
const sharedModel = require("../../models/sharedModel");


// List of
ripotiWamilikiRequestRouter.get("/ripoti-wamiliki-shule", isAuth, (req, res) => {
  const user = req.user;
    ...
    sharedModel.getSchoolOwnerships((ownerships) => {
      sharedModel.getRegistrationStructures((structures) => {
        sharedModel.getRegions(user , (regions) => {
            ...
            end_date = formatDate(date_range.split("to")[1], "YYYY-MM-DD");
              ...
              FROM (
                SELECT
                  ...
                  e.id AS school_id,
                  o.ownership_sub_type_id AS ownership_sub_type_id,
                  o.denomination_id AS denomination_id,
                  de.denomination AS denomination,
                  ost.sub_type AS sub_type,
                ...
                FROM applications a
                  ...
                  LEFT JOIN denominations de ON de.id = o.denomination_id
                ...
                WHERE a.application_category_id = 2
              ) school_owners_view
          ...
          const sqlRows = `SELECT tracking_number AS tracking_number , owner_name,denomination,sub_type , school_name , category, structure, 
	                     ...
	                     LIMIT ?, ?`;
	          const sqlCount = `SELECT COUNT(*) AS num_rows ${ownersFrom}`;
...
module.exports = ripotiWamilikiRequestRouter;
