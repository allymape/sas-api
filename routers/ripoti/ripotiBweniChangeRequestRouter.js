...
const ripotiBweniChangeRequestRouter = express.Router();
const { isAuth, formatDate } = require("../../utils");
const sharedModel = require("../../models/sharedModel");


// List of
ripotiBweniChangeRequestRouter.get("/ripoti-badili-bweni", isAuth, (req, res) => {
	  const user = req.user;
	  ...
	  sharedModel.getSchoolCategories((categories) => {
	    sharedModel.getSchoolOwnerships((ownerships) => {
            ...
            end_date = formatDate(date_range.split("to")[1], "YYYY-MM-DD");
              ...
              FROM (
                ...
                FROM applications a
                  ...
                  LEFT JOIN school_sub_categories ossc ON ossc.id = fsi.school_sub_category_id
                ...
                WHERE a.application_category_id = 14
              ) bweni_change_view
          ...
          const sqlRows = `SELECT tracking_number AS tracking_number , school_name , category, subcategory, old_subcategory, structure, 
	                     ...
	                     LIMIT ?, ?`;
	          const sqlCount = `SELECT COUNT(*) AS num_rows ${bweniFrom}`;
...
module.exports = ripotiBweniChangeRequestRouter;
