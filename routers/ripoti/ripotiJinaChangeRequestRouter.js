...
const ripotiJinaChangeRequestRouter = express.Router();
const { isAuth, formatDate } = require("../../utils");
const sharedModel = require("../../models/sharedModel");


// List of
ripotiJinaChangeRequestRouter.get("/ripoti-badili-jina", isAuth, (req, res) => {
	  const user = req.user;
	  ...
	  sharedModel.getSchoolCategories((categories) => {
	    sharedModel.getSchoolOwnerships((ownerships) => {
            ...
            end_date = formatDate(date_range.split("to")[1], "YYYY-MM-DD");
              ...
              FROM (
                SELECT
                  ...
                  fsi.school_name AS old_school_name,
                ...
                WHERE a.application_category_id = 9
              ) name_change_view
          ...
          const sqlRows = `SELECT tracking_number AS tracking_number ,school_name , old_school_name , category, structure, 
	                     ...
	                     LIMIT ?, ?`;
	          const sqlCount = `SELECT COUNT(*) AS num_rows ${nameChangeFrom}`;
              ...
              return res.send({
                ...
                structures,
	                ...
	                message: error
	                  ...
	                  : "Ripoti ya kubadili jina la shule.",
	              });
	            },
	            [offset, per_page]
	          );
...
module.exports = ripotiJinaChangeRequestRouter;
