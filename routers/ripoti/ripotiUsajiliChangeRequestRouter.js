...
const ripotiUsajiliChangeRequestRouter = express.Router();
const { isAuth, formatDate } = require("../../utils");
const sharedModel = require("../../models/sharedModel");


// List of
ripotiUsajiliChangeRequestRouter.get("/ripoti-badili-usajili", isAuth, (req, res) => {
	  const user = req.user;
	  ...
	  sharedModel.getSchoolCategories((categories) => {
	    sharedModel.getSchoolOwnerships((ownerships) => {
            ...
            end_date = formatDate(date_range.split("to")[1], "YYYY-MM-DD");
              ...
              FROM (
                ...
                FROM applications a
                  ...
                  LEFT JOIN school_categories scf ON scf.id = fsi.school_category_id
                ...
                WHERE a.application_category_id = 6
              ) registration_change_view
          ...
          const sqlRows = `SELECT tracking_number AS tracking_number , school_name , category , old_category, structure, 
                            ...
                            END AS approved,
                            approved_at
	                     ${registrationChangeFrom} 
	                     ORDER BY school_name DESC
	                     LIMIT ?, ?`;
	          const sqlCount = `SELECT COUNT(*) AS num_rows ${registrationChangeFrom}`;
              ...
              return res.send({
                ...
                structures,
	                ...
	                message: error
	                  ...
	                  : "Ripoti ya kubadili aina ya usajili.",
	              });
            },
            [offset, per_page]
          );
...
module.exports = ripotiUsajiliChangeRequestRouter;
