...
trackApplicationRouter.get("/track_applications", isAuth, permission('view-track-application'), (req, res) => {
  ...
  trackApplicationModel.getAllApplications(offset, per_page, is_paginated , (error, applications, numRows) => {
